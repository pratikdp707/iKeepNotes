...
export const Register = () => {
    ...
    const handleClick = (e) => {
        e.preventDefault();
        if(register(user.name, user.email, user.password)){
            history.push('/login');
        }
    }
        ...
        <div className='bg-light min-vh-100 pt-5'>
            <div className="auth-container p-5">
                ...
                <form action="" className='mb-5'>
                    ...
                    <input type="text" className="auth-input form-control mb-3" placeholder='Email' name="email" id="email" required onChange={onChange}/>
                    <input type="text" className="auth-input form-control" minLength={5} required placeholder='Password (min 5 characters)' name="password" id="password" onChange={onChange}/>
